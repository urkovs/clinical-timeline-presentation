...
const milestones = [
  ...
  ["initial-neuro", "2024-11-18", "workup", "workup", "phase-1", 2, "First visit: NDPH", "NDPH diagnosis at first visit; amitriptyline and Medrol started."],
  ["nurtec-ubrelvy", "2024-11-25", "treatment", "treatment", "phase-1", 0, "Nurtec + Ubrelvy samples", "Nurtec and Ubrelvy clinic samples trialed early; both ineffective."],
  ["dec-playbook", "2024-12-12", "treatment", "treatment", "phase-2", 1, "Playbook escalation", "Medrol helped only while taking it; Zavzpret ineffective; PT started; ketorolac/B12 rescue; Botox pursued."],
  ["first-botox", "2025-01-13", "treatment", "treatment", "phase-2", 2, "First Botox cycle", "First Botox cycle."],
...
].map(([id, date, lane, category, phaseId, row, title, significance]) => ({
  id,
  date,
  lane,
  category,
